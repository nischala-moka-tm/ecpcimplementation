...
function UserForm() {
  ...
  const [
    { firstname, midname, lastname, email, phone, address, city, zipcode },
    setValues,
  ] = useState([]);
        ...
        <div className="form-container">
          ...
          <Row>
            ...
            <Col md={12} className="text-disclaimer">
              <p>
                <span className="text-red">Disclaimer </span> : This information
                is only used to save the Preferences Settings
              </p>
            </Col>
          </Row>
        </div>
