			...
			<Row className="default-mode" readOnly={props.onlyDelete}>
				...
				<Col md={6}>
					<input
						...
						defaultChecked={props.default.some((d) => d === "email")}
					/>
					...
					<input
						...
						readOnly={props.onlyDelete}
						onChange={props.onDefaultCommChecked}
						defaultChecked={props.default.some((d) => d === "post")}
					/>
					...
					<input
						...
						readOnly={props.onlyDelete}
						onChange={props.onDefaultCommChecked}
						defaultChecked={props.default.some((d) => d === "call")}
					/>
					...
					<input
						...
						readOnly={props.onlyDelete}
						onChange={props.onDefaultCommChecked}
						defaultChecked={props.default.some((d) => d === "sms")}
					/>
