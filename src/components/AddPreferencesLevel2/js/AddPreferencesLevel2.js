...
import "../scss/AddPreferencesLevel2.scss";
...
function AddPreferencesLevel2(props) {
  const userData = {
  ...
  return (
    <Modal
      className="modalpopup modal-preferencelevel2"
      show={props.show}
      onHide={onResetAll}
    >
...
export default AddPreferencesLevel2;
